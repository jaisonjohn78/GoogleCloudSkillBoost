...
echo "${GREEN_TEXT}${BOLD_TEXT}══════════════════════════════════════════════${RESET_FORMAT}"
echo
echo "${RED_TEXT}${BOLD_TEXT}Jesus Loves you!❤️${RESET_FORMAT}"
echo "${YELLOW_TEXT}${BOLD_TEXT}${UNDERLINE_TEXT}👉 https://code-with-jaison.pages.dev${RESET_FORMAT}"
echo
echo "${MAGENTA_TEXT}${BOLD_TEXT}Bye Bye!${RESET_FORMAT}"